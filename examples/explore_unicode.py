...
unicode.compute_field("uppercase_int", lambda r: int(r.uppercase_hex, 16))
unicode.compute_field("lowercase_int", lambda r: int(r.lowercase_hex, 16))
unicode.compute_field("titlecase_int", lambda r: int(r.titlecase_hex, 16))
unicode.compute_field("character", lambda r: chr(r.code_value))
unicode.compute_field("uppercase", lambda r: chr(r.uppercase_int))
unicode.compute_field("lowercase", lambda r: chr(r.lowercase_int))
unicode.compute_field("titlecase", lambda r: chr(r.titlecase_int))
